...
const Notification = () => {
  ...
  return (
    <div className={`absolute right-[18rem] top-16 rounded-xl w-[23vw] h-[100vh] ${dark?`bg-slate-800 border-slate-700`:`bg-slate-100 border-slate-300`} z-[11] p-2 flex flex-col overflow-scroll no-scrollbar border-2 `}>
