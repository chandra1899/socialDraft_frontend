...
const Following=({following})=>{
  ...
  return (
    <div key={following._id} className={`flex flex-col  transition duration-150 ease-in-out ${dark?"bg-black hover:bg-[#232334]":"bg-white hover:bg-slate-100"} rounded-2xl left-2  p-2 mb-2 w-[330px] min-w-[75vw]  cursor-pointer`} onClick={()=>{setFollowingDiv(false);navigate(`/people/${following.followable._id}`)}}>
